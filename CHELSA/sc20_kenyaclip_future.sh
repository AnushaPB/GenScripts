...
##SBATCH -n 1 -c 1 -N 1
#SBATCH -t 24:00:00
#SBATCH -o /gpfs/scratch60/fas/caccone/apb56/stdout/sc20_ugandaclip_future.sh.%J.out
#SBATCH -e /gpfs/scratch60/fas/caccone/apb56/stderr/sc20_ugandaclip_future.sh.%J.err                       
#SBATCH --mail-type=ALL                                                         
#SBATCH --mail-user=anusha.bishop@yale.edu                                                      
#SBATCH --job-name=sc20_clip.sh  

ulimit -c 0

cd /home/fas/caccone/apb56/project/CHELSA/future/prec

OUTDIR=/home/fas/caccone/apb56/project/CHELSA/future/prec/uganda_clips
...
gdal_translate -projwin 28.6 4.73 35.4 -1.5 $OUTDIR/CHELSA_prec_${n}_rcp45_2041-2060_Edit.tif $OUTDIR/CHELSA_prec_${n}_rcp45_2041-2060_UgandaClip.tif
...
OUTDIR=/home/fas/caccone/apb56/project/CHELSA/future/tmax/uganda_clips
...
gdal_translate -projwin 28.6 4.73 35.4 -1.5 $OUTDIR/CHELSA_tmax_${n}_rcp45_2041-2060_Edit.tif $OUTDIR/CHELSA_tmax_${n}_rcp45_2041-2060_UgandaClip.tif
...
OUTDIR=/home/fas/caccone/apb56/project/CHELSA/future/tmin/uganda_clips
...
gdal_translate -projwin 28.6 4.73 35.4 -1.5 $OUTDIR/CHELSA_tmin_${n}_rcp45_2041-2060_Edit.tif $OUTDIR/CHELSA_tmin_${n}_rcp45_2041-2060_UgandaClip.tif
...
OUTDIR=/home/fas/caccone/apb56/project/CHELSA/future/tmean/uganda_clips
...
gdal_translate -projwin 28.6 4.73 35.4 -1.5 $OUTDIR/CHELSA_tmean_${n}_rcp45_2041-2060_Edit.tif $OUTDIR/CHELSA_tmean_${n}_rcp45_2041-2060_UgandaClip.tif
