...
OUTDIR=/project/fas/caccone/apb56/CHELSA/tmean_mean/kenya_clips
...
gdal_translate -projwin 33.7 4.73 42.5 -4.8 $OUTDIR/CHELSA_tmean_${n}_V1.2.1_Edit.tif $OUTDIR/CHELSA_tmean_${n}_V1.2.1_KenyaClip.tif
