...
OUTDIR=/project/fas/caccone/apb56/CHELSA/tmin_mean/uganda_clips
...
gdal_translate -projwin 28.6 4.73 35.4 -1.5 $OUTDIR/CHELSA_tmin_${n}_V1.2.1_Edit.tif $OUTDIR/CHELSA_tmin_${n}_V1.2.1_UgandaClip.tif
