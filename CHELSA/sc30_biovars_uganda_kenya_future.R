...
tmax_uganda_kenya<-(tmax_uganda_kenya/10 + 273.15)*10 #convert from celsius * 10 to kelvin * 100 
...
tmin_uganda_kenya<-(tmin_uganda_kenya/10 + 273.15)*10 #convert from celsius * 10 to kelvin * 100 
...
writeRaster(biovar_uganda_kenya.future,"/home/fas/caccone/apb56/project/CHELSA/biovars/UgandaKenyaBiovarsFuture",format="GTiff",overwrite=TRUE)