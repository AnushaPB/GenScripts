...
writeRaster(StraightPred, paste0("/home/fas/caccone/apb56/project/GPDGENCON/Edwards/LOPOCV/MEDIAN/StraightPaths_EBKM_Point",foldnum,".RData"), format="GTiff", overwrite=TRUE)

save.image(paste0("/home/fas/caccone/apb56/project/GPDGENCON/Edwards/LOPOCV/MEDIAN/EdwardsBouyerKernelMed_Point",foldnum,".RData"))
