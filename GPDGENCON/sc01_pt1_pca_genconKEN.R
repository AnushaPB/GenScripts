...
G.table <- read.table(file="/home/fas/caccone/apb56/project/GFFGENCON/ken_pca_gendf.csv", sep=",", header=T)
...
for(i in 1:10){
  ...
  write.csv(testData, paste0("/home/fas/caccone/apb56/project/GPDGENCON/PCA/CV/testData_", i, ".csv"))
  trainData <- yourData[-testIndexes, ]
  assign(paste0("trainData_", i), trainData)
  write.csv(trainData, paste0("/home/fas/caccone/apb56/project/GPDGENCON/PCA/CV/trainData_", i, ".csv"))
}


save.image(file = "/home/fas/caccone/apb56/project/GPDGENCON/PCA/CV/RF_pt1.RData")