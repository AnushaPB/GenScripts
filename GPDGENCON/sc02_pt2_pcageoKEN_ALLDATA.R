...
G.table <- read.table(file="/home/fas/caccone/apb56/project/GPDGENCON/ken_pca_gengeobtwdf.csv", sep=",", header=T)
...
write.csv(StraightMeanUniqDF,"/home/fas/caccone/apb56/project/GPDGENCON/PCA/StraightMeanUniqGeoDF.csv")
...
write.csv(StraightMeanDF,"/home/fas/caccone/apb56/project/GPDGENCON/PCA/StraightMeanGeoDF.csv")
...
save.image(paste0("/home/fas/caccone/apb56/project/GPDGENCON/PCA/LinPCAGeoData_beforeLCP_AllData.RData"))
