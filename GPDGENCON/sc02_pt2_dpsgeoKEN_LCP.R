...
pdf(paste0("/home/fas/caccone/apb56/project/GPDGENCON/DPS/CV/GeoLinData_Run",foldnum,"_StraightRF_TrainingScatter.pdf"), 5, 5)
...
pdf(paste0("/home/fas/caccone/apb56/project/GPDGENCON/DPS/CV/GeoLinData_Run",foldnum,"_StraightRF_ValidScatter.pdf"), 5, 5)
...
save.image(paste0("/home/fas/caccone/apb56/project/GPDGENCON/DPS/CV/GeoLinDPSData_beforeLCP_Fold",foldnum,".RData"))
...
save.image(paste0("/home/fas/caccone/apb56/project/GPDGENCON/DPS/CV/GeoLinDPSData_afterLCP_Fold",foldnum,".RData"))
...
write.csv(d, paste0("/home/fas/caccone/apb56/project/GPDGENCON/DPS/CV/GeoLinDisData_Run", foldnum, "_ValidationTable.csv"), row.names =FALSE)
...
pdf(paste0("/home/fas/caccone/apb56/project/GPDGENCON/DPS/CV/GeoLinDisData_Run",foldnum,"_BestCor2_Pred_it",best_it,".pdf"), 5, 5)
plot(get(ResistanceMap))
dev.off()

fit = lm(get(RF)$predicted ~ LcpLoopDF.train$value)
#adjr2 = round(summary(fit)$adj.r.squared, digits=3)
pdf(paste0("/home/fas/caccone/apb56/project/GPDGENCON/DPS/CV/GeoLinDisData_Run",foldnum,"_BestCor2_TrainingScatter_it", best_it, ".pdf"), 5, 5)
...
#adjr2 = round(summary(fit)$adj.r.squared, digits=3)
pdf(paste0("/home/fas/caccone/apb56/project/GPDGENCON/DPS/CV/GeoLinDisData_Run",foldnum,"_BestCor2_ValidScatter_it", best_it,".pdf"), 5, 5)
plot(LcpLoopDF.test$value, predict(get(RF), LcpLoopDF.test),  xlab ="Observed DPS* (valid)", ylab="Predicted DPS")
#legend("bottomright", legend=c(paste0("Adj. R^2 = ", adjr2)), cex=0.7)
dev.off()

pdf(paste0("/home/fas/caccone/apb56/project/GPDGENCON/DPS/CV/GeoLinDisData_Run",foldnum,"_BestCor2_ImpVars_it",best_it,".pdf"), 5, 5)
varImpPlot(get(RF))
dev.off()
