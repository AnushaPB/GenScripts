...
Test.table <- read.table(file=paste0("/home/fas/caccone/apb56/project/GPDGENCON/Reynolds/CV/testData_", foldnum, ".csv"), sep=",", header=T)

Train.table <- read.table(file=paste0("/home/fas/caccone/apb56/project/GPDGENCON/Reynolds/CV/trainData_", foldnum, ".csv"), sep=",", header=T)
...
save.image(paste0("/home/fas/caccone/apb56/project/GPDGENCON/Reynolds/NOQUART/CV/LinReynoldsBouyerKernelNOQuart_beforeLCP_Fold",foldnum,".RData"))
...
for (it in 1:3) {
  ...
  #Add Reynolds distance to the datasets
...
save.image(paste0("/home/fas/caccone/apb56/project/GPDGENCON/Reynolds/NOQUART/CV/LinReynoldsBouyerKernelNOQuart_afterLCP_Fold",foldnum,".RData"))
