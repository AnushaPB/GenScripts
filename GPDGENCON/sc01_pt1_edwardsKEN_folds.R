...
for(i in 1:10){
  ...
  write.csv(testData, paste0("/home/fas/caccone/apb56/project/GPDGENCON/Edwards/CV/testData_", i, ".csv"))
  trainData <- yourData[-testIndexes, ]
  assign(paste0("trainData_", i), trainData)
  write.csv(trainData, paste0("/home/fas/caccone/apb56/project/GPDGENCON/Edwards/CV/trainData_", i, ".csv"))
}


save.image(file = "/home/fas/caccone/apb56/project/GPDGENCON/Edwards/CV/RF_pt1.RData")